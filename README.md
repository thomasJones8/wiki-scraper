...
A Python CLI application for automated data extraction, BFS web crawling, and NLP-based language analysis of MediaWiki websites. 
...
*Note: This project was developed as a major assignment for the programming course (1st Year Computer Science) at the MIMUW faculty. For the detailed academic requirements (in Polish), see [SPECIFICATION_PL.md](SPECIFICATION_PL.md).*
...
```bash
python wiki_scraper.py --auto-count-words "Team Rocket" --depth 3 --wait 1
```
